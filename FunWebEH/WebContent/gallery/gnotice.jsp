...
<nav id="sub_menu">
<ul>
<li><a href="../gallery/gnotice.jsp">갤러리</a></li>
</ul>
</nav>
<!-- 왼쪽메뉴 -->
<%
...
<table id="notice">
    ...
    for(int i=0;i<boardList.size();i++){
    	...
    	%>
<tr onclick="location.href='gcontent.jsp?num=<%=bb.getNum()%>&pageNum=<%=pageNum%>'">
<td class="left">
<img src="../upload/<%=bb.getFile()%>" width="300" height="150"><br><%=bb.getSubject() %><br><%=bb.getName() %><%=sdf.format(bb.getDate()) %></td></tr>   	
    	<%
    }
    %>
</table>
...
<input type="button" value="글쓰기" class="btn" 
  onclick="location.href='gwriteForm.jsp'">
</div>
	<%
}
%>
<div id="table_search">
<form action="gnoticeSearch.jsp" method="get">
